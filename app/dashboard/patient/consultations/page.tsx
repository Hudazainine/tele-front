...
const TYPE_COLORS: Record<string, { color: string; bg: string }> = {
  ...
  "Avis spécialisé": { color: "#185FA5", bg: "#EEEDFE" },
    ...
    return (
      ...
      >
        <div style={{ textAlign: "center" }}>
          ...
          <div style={{ fontSize: 14, color: "#378ADD", fontWeight: 600 }}>
            Chargement...
          </div>
        </div>
      </div>
          ...
          <div className="pg-header">
            <div>
              ...
              <div className="pg-sub">
                ...
                {consultations.length !== 1 ? "s" : ""} dans votre historique
              </div>
            </div>
          </div>
                ...
                {loading ? (
                  ...
                  filtered.map((c) => (
                    ...
                    >
                      ...
                      {c.type_consultation &&
                        (() => {
                          const t = TYPE_COLORS[c.type_consultation] || {
                            color: "#185FA5",
                            bg: "#EEEDFE",
                          };
                          return (
                ...
                <div className="detail-card">
                  ...
                  <div className="det-hd">
                    <div className="det-hd-top">
                      <div className="det-dr">
                        Dr. {selected.medecin_name || "—"}
                      </div>
                      <span className="det-date-badge">
                        {selected.date_heure
                          ? new Date(selected.date_heure).toLocaleDateString(
                              "fr-FR",
                              {
                                day: "numeric",
                                month: "long",
